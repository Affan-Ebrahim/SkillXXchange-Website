...
export default function Login() {
  ...
  return (
    <>
      <SuccessModal isOpen={showSuccess} onClose={() => setShowSuccess(false)} message="Logged in successfully!" />
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-[#00BFA5] hover:text-[#00A890]">
                Forgot Password?
              </a>
            </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md hover:bg-gray-50 transition">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/signup" className="text-[#00BFA5] hover:text-[#00A890] font-semibold">
                Sign up
              </Link>
            </p>
          </div>
